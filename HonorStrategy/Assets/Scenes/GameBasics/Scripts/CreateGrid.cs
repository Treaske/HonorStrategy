        ...
        for (int c = 0; c < 12; c++)
        {
            ...
            for (int l = 12; l > (12 - sameColumnCharacters.Count); l--)
            {
                ...
                List<CharInfo> sameLineCharacters = posicionesOcupadas
                 ...
                 Debug.Log("Color in " + charIn.colorInt);


                //---------- buscar characters mismo color para wall (horizontalmente)-----------------------------------------------------------------------------------
                for (int f = c; f < 12; f++)
                {
                    ...
                    if(charAp != null)
                    {
                         Debug.Log("Color ap " + charAp.colorInt);
                ...
                Debug.Log("Hola " + matchedTilesWall.Count);
